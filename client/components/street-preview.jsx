            ...
            <section className='preview-container'>
                ...
                <div className='preview-img-stack-container'>
                    <div className='preview-img-container'>
                        <img src='Imgs/street1.jpg' alt='portrait' className='preview-img' onClick={changeMainImg1} data-aos='fade-right' data-aos-duration={2500} data-aos-delay={150}/>
                    </div>
                    <div className='preview-img-container'>
                        <img src='Imgs/street2.jpg' alt='portrait' className='preview-img' onClick={changeMainImg2} data-aos='fade' data-aos-duration={2000} data-aos-delay={150}/>
                    </div>
                    <div className='preview-img-container'>
                        <img src='Imgs/street3.jpg' alt='portrait' className='preview-img' onClick={changeMainImg3} data-aos='fade' data-aos-duration={1500} data-aos-delay={150}/>
                    </div>
                    <div className='preview-img-container'>
                        <img src='Imgs/street4.jpg' alt='portrait' className='preview-img' onClick={changeMainImg4} data-aos='fade' data-aos-duration={2000} data-aos-delay={150}/>
                    </div>
                    <div className='preview-img-container'>
                        {<img src='Imgs/street5.jpg' /* style={{
                height: '400px',
                width: '325px',
                border: '4px solid #081C15'
            }}  */
             alt='portrait' className='preview-img' onClick={changeMainImg5} data-aos='fade' data-aos-duration={1500} data-aos-delay={150}/> }
                    ...
                    <div className='preview-img-container'>
                        <img src='Imgs/street6.jpg' alt='portrait' className='preview-img' onClick={changeMainImg6} data-aos='fade' data-aos-duration={2000} data-aos-delay={150}/>
                    </div>
                </div>
